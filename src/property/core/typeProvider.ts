...
import { NS_SYSTEM_SCHEMA_PROPERTY_CORE, NS_SYSTEM_STRING, SCHEMA_KIND_PROPERTY } from "../../utility/constant";
import { ReadOnly } from "../common/readOnly";
import { InVisible } from "../common/invisible";

/** The type provider property. */
@Meta(OfSchema, SCHEMA_KIND_PROPERTY)
@Meta(SchemaType, `${NS_SYSTEM_SCHEMA_PROPERTY_CORE}.typeprovider`)
@Meta(Static, true)
@Meta(ReadOnly, true)
@Meta(InVisible, true)
