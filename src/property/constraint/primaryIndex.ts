...
@Meta(SchemaType, `${NS_SYSTEM_SCHEMA_PROPERTY_CONSTRAINT}.primaryindex`)
@Meta(PropertyValueType, NS_SYSTEM_STRING)
export class PrimaryIndex extends OrderProperty<string> implements IConstraintProperty {
