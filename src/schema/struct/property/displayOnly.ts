...
import { SCHEMA_KIND_PROPERTY, NS_SYSTEM_BOOL, SCHEMA_KIND_STRUCT_FIELD, NS_SYSTEM_SCHEMA_PROPERTY_STRUCT } from '../../../utility/constant';
...
@Meta(SchemaType, `${NS_SYSTEM_SCHEMA_PROPERTY_STRUCT}.DisplayOnly`)
