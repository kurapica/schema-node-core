...
import { SCHEMA_KIND_PROPERTY, NS_SYSTEM_INT, SCHEMA_KIND_STRING, NS_SYSTEM_SCHEMA_PRO_STRING, SCHEMA_KIND_STRING_DEFINE, SCHEMA_KIND_STRING_USAGE } from '../../../utility/constant';

@Meta(Alias, 'uplimit')
@Meta(ForSchema, [SCHEMA_KIND_STRING, SCHEMA_KIND_STRING_DEFINE, SCHEMA_KIND_STRING_USAGE])
@Meta(OfSchema, SCHEMA_KIND_PROPERTY)
@Meta(SchemaType, `${NS_SYSTEM_SCHEMA_PRO_STRING}.uplimit`)
@Meta(PropertyValueType, NS_SYSTEM_INT)
@Meta(Error, `${NS_SYSTEM_SCHEMA_PRO_STRING}.uplimit.error`)
